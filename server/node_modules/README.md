# Anuglar IMAGE UPLOADER (ALAN SCHAMBERS)

Added angular image file uploader. There are different file uploaders and more can be read below. Added quite a few bower components 
to this repository (under images branch), as well as edited config.json. Also added directives folder, services folder, and values folder.
Again, you can read more below. 
